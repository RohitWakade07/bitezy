...
import { signInWithEmail, signOutUser, signInWithGoogle } from '../../firebase/auth';
import { 
  Store, 
  Mail, 
  Lock, 
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Canteen Login</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center justify-center space-x-2"
          >
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-gray-500">
            For canteen staff only. Regular users should{' '}
...
export default CanteenLoginPage;
